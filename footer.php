        ...
        <div class="footer__widgets">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget">
                        <a href="index.html">
                            <img src="img/LOGO-BAOTHANHNIEN.png" srcset="img/LOGO-BAOTHANHNIEN.png 1x, img/LOGO-BAOTHANHNIEN.png 2x" class="logo__img" alt="">
                        </a>
                        <p class="mt-20">Báo thanh niên mang đến những bài báo chính xác và chất lượng nhất đến với người dùng</p>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6">
                    <h4 class="widget-title">Bài viết nổi bật hôm nay</h4>
